...
namespace LLama.Executors
{
    ...
    /// </summary>
    public abstract class StatefulExecutorBase<T> : ILLamaStatefulExecutor
        where T : ExecutorBaseState
    {
        /// <summary>
        ...
        /// <summary>
        /// Service for savving the executor state
        /// </summary>
        protected readonly IStateService<T> _stateService;
        ...
        protected StatefulExecutorBase(LLamaModel model, string? stateFile, ILLamaLogger? logger = null)
            : this(model, new JsonFileStateService<T>(stateFile), logger)
        {
        }
        ...
        /// <param name="logger"></param>
        protected StatefulExecutorBase(LLamaModel model, IStateService<T> stateService, ILLamaLogger? logger = null)
        {
            _model = model;
            _logger = logger;
        ...
        public unsafe StatefulExecutorBase<T> WithSessionFile(string filename)
        {
        ...
        /// </summary>
        /// <param name="filename"></param>
        [Obsolete("Use IStateService implemetation")]
        ...
        /// </summary>
        /// <returns></returns>
        public abstract T GetStateData();

        /// <summary>
        /// Load the state from data.
        /// </summary>
        /// <param name="data"></param>
        public abstract void LoadState(T data);
        ...
        {
            LoadState(_stateService.Load());
        }


        /// <summary>
        /// Load the state async
        /// </summary>
        public virtual async Task LoadStateAsync()
        {
            LoadState(await _stateService.LoadAsync());
        }
        ...
        {
            return _stateService.Save(GetStateData());
        }
        ...
        /// </summary>
        public virtual Task<bool> SaveStateAsync()
        {
            return _stateService.SaveAsync(GetStateData());
        }
